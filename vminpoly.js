...
// Note: I'm not yet acting smart enough to actually handle astral characters.
  ...
  initLayoutEngine = function() {
    var analyzeStyleRule, analyzeStylesheet, head, links, onresize, sheets, styleElement, _i, _len;
      ...
      generateRuleCode = function(rule) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            token = _ref1[_j];
            if (token.tokenType === 'DIMENSION' && (token.unit === 'vmin' || token.unit === 'vh' || token.unit === 'vw')) {
              ruleCss += "" + (Math.floor(token.num * dims[token.unit])) + "px!important";
            } else {
    ...
    const contentLoaded = function () {
      ...
      for (_i = 0, _len = links.length; _i < _len; _i++) {
        var sheet, tokenlist;
        tokenlist = tokenize(links[_i].innerHTML);
      ...
      var innerSheetCount = 0;
      var outerSheetCount = 0;
      for (_i = 0, _len = links.length; _i < _len; _i++) {
        (function () {
          var i = links[_i];
          if (i.rel !== 'stylesheet') {
          ...
          innerSheetCount++;
          var afterAjax = function (cssText) {
            var sheet, tokenlist;
